...
def ben(lastMove="C", deflections=0): # Ben = cooperative
...
for i in range(20):
    ...
    p1_points, p2_points, p3_points, p4_points, p5_points = pointCalc(last_ben_move, last_almanac_move, last_lana_move, last_ray_move, last_forlot_move, p1_points, p2_points, p3_points, p4_points, p5_points,'ben', 'almanac', 'lana', 'ray', 'forlot')
...
plt.ylabel('Points')
plt.title('Points Accumulation Over Iterations (With one incrediably forgiving)')
plt.legend()
plt.show()